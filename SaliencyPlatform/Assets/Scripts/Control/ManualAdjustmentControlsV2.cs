...
public class ManualAdjustmentControlsV2 : MonoBehaviour
{
    // Laser 
    ...
    private ManualAdjustmentControlsV2 m_otherManualAdjustmentControls;
    private ContainerSetupControlsV2 m_thisOptimizationControls, m_otherOptimizationControls;
    ...
    private void initControllers()
    {
        ...
        m_thisOptimizationControls = gameObject.GetComponent<ContainerSetupControlsV2>();
